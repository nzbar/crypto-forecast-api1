...
try:
    ...
    # --- Start of added/modified section for saving path ---
    # Define the directory where models will be saved
    models_dir = os.path.join(args.path, 'models')
                ...
                try:
                    ...
                    if mdl == 'gru':
                        ...
                        try:
                            ...
                            # --- MODIFIED: Save model to 'models' directory ---
                    ...
                    # XGBoost
                        ...
                        try:
                            ...
                            # --- MODIFIED: Save model to 'models' directory ---
                            file_path = os.path.join(models_dir, filename + '.txt')
